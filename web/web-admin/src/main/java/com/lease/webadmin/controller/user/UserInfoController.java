package com.lease.webadmin.controller.user;
...
public class UserInfoController {
    ...
    public Result<IPage<UserInfo>> pageUserInfo(@RequestParam long current, @RequestParam long size, UserInfoQueryVo queryVo) {
        ...
        userInfoLambdaQueryWrapper.like(queryVo.getPhone()!=null,UserInfo::getPhone,queryVo.getPhone()).eq(queryVo.getStatus()!=null,UserInfo::getStatus,queryVo.getStatus());
        IPage<UserInfo> page = userInfoService.page(userInfoPage, userInfoLambdaQueryWrapper);
